...
export default function FAQ() {
  ...
  const faqs = [
    {
      question: t("faqOne.question"),
      answer: t("faqOne.answer"),
    },
    {
      question: t("faqTwo.question"),
      answer: t("faqTwo.answer"),
    },
    {
      question: t("faqThree.question"),
      answer: t("faqThree.answer"),
    },
    {
      question: t("faqFour.question"),
      answer: t("faqFour.answer"),
    },
    {
      question: t("faqFive.question"),
      answer: t("faqFive.answer"),
    },
    {
      question: t("faqSix.question"),
      answer: t("faqSix.answer"),
    },
  ];
    ...
    <section className="w-full py-32">
      <Container>
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-0 justify-start lg:justify-between px-4">
          <h2 className="text-heading-4 md:text-heading-3 lg:text-[42px]">
            FAQ
          </h2>
          <div className="w-full lg:w-[70%] max-w-full relative z-2">
