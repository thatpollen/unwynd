                  ...
                  {isMobile ? (
                    ...
                    <div className="flex justify-center items-center gap-2 flex-nowrap">
                      <div className="testimonials_column-left relative">
                        ...
                        <div className="absolute top-0 translate-y-full flex flex-col items-center gap-2">
                          {testimonials.map((testimonial, index) => (
                            <Testimonial
                              testimonial={testimonial}
                              key={index}
                      ...
                      <div className="testimonials_column-middle relative">
                        ...
                        <div className="absolute bottom-0 -translate-y-full flex flex-col items-center gap-2">
                          {testimonials.map((testimonial, index) => (
                            <Testimonial
                              testimonial={testimonial}
                              key={index}
