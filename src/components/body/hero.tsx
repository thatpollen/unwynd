...
//       setText(sequence[index]);
//       setIsBreathingIn(index === 0); // True for "breathe in", false for "breathe out"

//       if (index === 0) {
//         setOpacity(1); // Background visible when breathing in
//       } else {
//         setOpacity(0); // Background fades to white when breathing out
//       }
//     }, 10000); // 5s per phase
